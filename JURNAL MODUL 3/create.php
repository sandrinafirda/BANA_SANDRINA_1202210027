...
// (3) Jika sudah coba deh kalian ambil data dari form (CLUE : pakai POST)
    ...
    $query = mysqli_query ($connect, "INSERT INTO showroom mobil(nama mobil, brand mobil, warna mobil, tipe mobil, harga mobil) VALUES ('$nama_mobil', '$brand_mobil', '$warna_mobil', '$tipe_mobil', '$harga_mobil')");
